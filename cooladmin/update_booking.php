...
if ($stmt->execute()) {
    ...
    $mail->SMTPSecure = 'ssl';
    $mail->Port = 465;
    $mail->setFrom('portfolio@techbyfrancis.com', 'villacharlenne Notification');
    $mail->isHTML(true);
    ...
    switch (strtolower($booking_status)) {
        case 'confirmed':
            $subject = "Your Booking is Confirmed - villacharlenne";
            $body = "
                ...
                <br>
                <p>Best regards,<br>villacharlenne Team</p>
            ";
            break;

        case 'pending':
            $subject = "Your Booking is Pending - villacharlenne";
            $body = "
                <h3>Hello {$fullnames},</h3>
        ...
        case 'cancelled':
        case 'canceled':
            $subject = "Your Booking Has Been Cancelled - villacharlenne";
            $body = "
                <h3>Hello {$fullnames},</h3>
        ...
        default:
            $subject = "Booking Update - villacharlenne";
            $body = "
                <h3>Hello {$fullnames},</h3>

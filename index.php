                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 col-lg-9">
                            ...
                            <div class="hero-slides-content" data-animation="fadeInUp" data-delay="100ms">
                                ...
                                <a href="#" class="btn palatin-btn mt-50 text-light" data-animation="fadeInUp" data-delay="900ms">Read More</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-10">
                    <div class="book-now-form">
                        <form action="#">
                            ...
                            <!-- Button -->
                            <button type="submit" style="background-color: blue;">Book Now</button>
                        </form>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-6">
                    <div class="about-text text-center mb-100">
                        ...
                        <a href="#" class="btn palatin-btn mt-50 text-light">Read More</a>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-md-6 col-lg-4">
                    <div class="single-rooms-area wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <!-- Book Room -->
                        <a href="#" class="book-room-btn btn palatin-btn text-light">Book Room</a>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="footer-widget-area mt-50">
                        ...
                        <form action="#" method="post" class="subscribe-form">
                            ...
                            <button type="submit" class="text-light">Subscribe</button>
                        </form>
                    </div>
                </div>
